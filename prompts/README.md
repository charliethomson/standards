...
| [vision-project-from-codebase.md](vision-project-from-codebase.md) | Infer a vision project from a repo and create it. Bootstrap only — use `/thmsn-jarvis` to plan and decompose actual work. |
